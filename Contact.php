    ...
    <main>
        <section class="page-title-section page-title-section-kontakt">
            ...
            <div class="container page-title-content">
                <a href="#contact-form-section" class="page-title-link">
        ...
        <section class="booking-prompt">
            <div class="container">
                <p>Trebate zakazati termin? <a href="booking.php">Zakažite ovdje</a> i osigurajte svoj razgovor.</p>
            </div>
        </section>
                ...
                <div class="contact-info fade-in">
                    ...
                    <div class="info-item">
                        ...
                        <div>
                            ...
                            <p>Vidovdanska Ulica 2, 78000 Banja Luka</p>
                        </div>
                    </div>
                    <div class="info-item">
                    ...
                    <form action="#" method="POST" class="contact-form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="message" name="message" rows="6" required
                                placeholder="Kako Vam možemo pomoći?"></textarea>
                        </div>
