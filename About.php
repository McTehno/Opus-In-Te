        ...
        <div class="container">
            ...
            <nav class="main-nav">
                <ul>
                    ...
                    <li><a href="/o-meni" class="active">O Meni</a></li>
        ...
        <section class="about-me-main">
            <div class="container about-me-container">
                ...
                <div class="about-me-image-wrapper">
                    <div class="about-me-image fade-in">
                        <img src="img/vanjapic/vanja_profile.jpg" alt="Vanja Dejanović">
                    </div>
                </div>
                ...
                <div class="about-me-text-wrapper">
                    <div class="about-me-text">
                        ...
                        <p class="fade-in" data-delay="1"><strong>Moje ime je Vanja Dejanović, i moja misija je da Vam
                                pružim sigurno i podržavajuće okruženje u kojem možete slobodno istražiti svoje misli,
                                osjećaje i životne izazove.</strong></p>
                        <p class="fade-in" data-delay="2">Vjerujem da je psihoterapija putovanje koje klijent i terapeut
                            prolaze zajedno. To je proces otkrivanja unutrašnje snage, razumijevanja ličnih obrazaca i
                            izgradnje kapaciteta za ispunjeniji život. Moj pristup je utemeljen na empatiji, povjerenju
                            i dubokom poštovanju prema jedinstvenoj priči svake osobe.</p>
                    </div>
                </div>
            ...
            <div class="pull-quote-section">
                <div class="container">
                    <blockquote class="fade-in" data-delay="1">
                        "Opus in te – djelo u tebi – srž je moje filozofije: pomoći Vam da otkrijete i oblikujete
                        remek-djelo koje već nosite u sebi."
                    </blockquote>
                </div>
            </div>
            ...
            <div class="container about-me-qualifications">
                <div class="qualifications-content fade-in">
                    ...
                    <p>Moja fascinacija ljudskim umom i odnosima započela je davno, vodeći me ka formalnom obrazovanju
                        iz psihologije i kontinuiranom usavršavanju u različitim terapijskim modalitetima. Kroz godine
                        rada, shvatila sam da je najvažniji alat u terapiji istinski ljudski kontakt.</p>

                    <ul class="qualifications-list">
                        <li class="fade-in" data-delay="1"><i class="fas fa-certificate"></i><span>Certifikovani
                                psihoterapeut sa višegodišnjim iskustvom.</span></li>
                        <li class="fade-in" data-delay="2"><i class="fas fa-brain"></i><span>Specijalizacija u
                                Kognitivno-bihevioralnoj terapiji.</span></li>
                        <li class="fade-in" data-delay="3"><i class="fas fa-users"></i><span>Član relevantnih stručnih
                                udruženja.</span></li>
                        <li class="fade-in" data-delay="4"><i class="fas fa-book-open"></i><span>Kontinuirana edukacija
                                u skladu sa najvišim etičkim standardima.</span></li>
                    </ul>
                </div>
            </div>
        </section>
